...
{profilepic &&  <img
        ...
        <label  className='boxs' style={{position:'relative', left:125, color:'red'}} > || नमो बुध्दाय ||</label>
              </div>
              ...
              <div className='box'>
                  ...
                  <label htmlFor='name'>जीवन मौर्या</label>
                </div>
                <div className='box'>
  ...
  <label  className='boxs' style={{position:'relative', left:125, color:'red'}}>कौटुंबिक माहिती</label>
                ...
                <div className='box'>
                  ...
                  <label htmlFor='email'> इराम मौर्या </label>
                </div>
                <div className='box'>
                  <label className='title' htmlFor="nanlakksa">
                  वडिलांचा व्यवसाय:
                ...
                <div className='box'>
                  ...
                  <label htmlFor="nanlakksa"> जव मौर्या</label>
                </div>
                <div className='box'>
                  <label className='title' htmlFor="nanlakksa">
                  बहीण:
                  </label>
                  <label htmlFor="nanlakksa">वन मौर्या</label>
                </div>
                <div className='box'>
                  <label className='title' htmlFor="nanlakksa">
                  भाऊ:
                  </label>
                  <label htmlFor="nanlakksa">जीन मौर्या</label>
                </div>
                <div className='box'>
                  <label className='title' htmlFor="nanlakksa">
                  मामा:
                  </label>
                  <label htmlFor="nanlakksa">जीव मौर्या</label>
                </div>
