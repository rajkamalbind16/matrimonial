...
if(formValuess){console.log(localStorage)}
...
const handleSubmit = (event) => {
 ...
 if(temp == "BTemp1"){ console.log("true"), navigate(`/CreateBTemp1?${queryParams.toString()}`);}
 if(temp == "BTemp2"){ console.log("true"), navigate(`/CreateBTemp2?${queryParams.toString()}`);}
 if(temp == "BTemp3"){ console.log("true"), navigate(`/CreateBTemp3?${queryParams.toString()}`);}
 if(temp == "BTemp4"){ console.log("true"), navigate(`/CreateBTemp4?${queryParams.toString()}`);}
 if(temp == "CreateBTemp5"){ console.log("true"), navigate(`/CreateBTemp5?${queryParams.toString()}`);}
  ...
  return (
    ...
    <div className='mainFormssss'>
        ...
        <option value="|| नमो बुध्दाय ||  || जय भीम ||">|| नमो बुध्दाय ||  || जय भीम ||</option>
      </select>
      <br />
        <br />
...
<option value="31">31</option>
      ...
      <select value={formValuess.selectedMonth} name='selectedMonth' onChange={handleChange} required style={{fontSize:'20px',
    paddingRight:'40px',paddingLeft:'40px'
    }}>
      ...
      <select value={formValuess.selectedYear} name='selectedYear' onChange={handleChange} required style={{fontSize:'20px',
    paddingRight:'40px',paddingLeft:'40px'
    }}>
...
<option value="2023">2023</option>
    ...
    <div>
           <select value={formValuess.dobDay} name='dobDay' onChange={handleChange} required style={{fontSize:'20px',
