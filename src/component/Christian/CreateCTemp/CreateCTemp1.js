...
export default function CreateTemp() {
  ...
  const sharirikApangta = queryParams.get('sharirikApangta');
  const name = queryParams.get('name');
  const study = queryParams.get('study');
  const MarriStatus = queryParams.get('MarriStatus')
...
{profilePicture &&  <img
            ...
            >
              ...
              <div className='box'>
                ...
                <div className='box'>
                  <label className='title' htmlFor='sharirikApangta'>
                  शारीरिक अपंगत्व:
                  </label>
                  <label htmlFor='sharirikApangta'>{sharirikApangta}</label>
                </div>
                {/* <div className='box'>
                ...
                <div className='box'>
                  <label className='title' htmlFor='MarriStatus'>
                  वैवाहिक स्थिती:
                  </label>
                  <label htmlFor='MarriStatus'>{MarriStatus}</label>
                </div>
...
<div className="box">
    <label className="title" htmlFor="aapesha">
    अपेक्षा:
    </label>
    <label htmlFor="aapesha">{aapesha}</label>
  </div>
