...
{profilepic &&  <img
        ...
        <div className='box'>
              ...
              <label  className='boxs' style={{position:'relative', left:125, color:'red'}}  >  </label>
              </div>
             
              <div className='box'>
              
                <label  className='boxs' style={{position:'relative', left:135, color:'red'}} >बायोडाटा</label>
                </div>
                <br/>
              <div className='box'>
                  ...
                  <label htmlFor='name'>हिमांशु थॉमस </label>
                </div>
                <div className='box'>
  ...
  <label  className='boxs' style={{position:'relative', left:125, color:'red'}} >कौटुंबिक माहिती</label>
                ...
                <div className='box'>
                  ...
                  <label htmlFor='email'> जयेश थॉमस </label>
                </div>
                <div className='box'>
                  <label className='title' htmlFor="nanlakksa">
                  वडिलांचा व्यवसाय:
                ...
                <div className='box'>
                  ...
                  <label htmlFor="nanlakksa"> वन्दना थॉमस</label>
                </div>
                <div className='box'>
                  <label className='title' htmlFor="nanlakksa">
                  बहीण:
                  </label>
                  <label htmlFor="nanlakksa">वन्ना थॉमस</label>
                </div>
                <div className='box'>
                  <label className='title' htmlFor="nanlakksa">
                  भाऊ:
                  </label>
                  <label htmlFor="nanlakksa">जय थॉमस</label>
                </div>
                <div className='box'>
                  <label className='title' htmlFor="nanlakksa">
                  मामा:
                  </label>
                  <label htmlFor="nanlakksa">यश थॉमस</label>
                </div>
