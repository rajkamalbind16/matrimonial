...
import img1 from '../../template1/mimg1.jfif';
...
console.log(localStorage)
  ...
  const handleDownloadPDF = () => {
    const dpi = 500; // Set the desired DPI value
...
{profilePicture &&  <img
            ...
            >
              ...
              {/* <div className='box'>
               ...
               <label  className='boxs'  style={boxStyles}>||  {greetGod}  ||</label>
              </div> */}
              ...
              <div className='box'>
                  ...
                  नाव:
                   ...
                   <label style ={{ color:'yellow'}} htmlFor='name'>{name}</label>
                </div>
                <div className='box'>
                ...
                {/* <div className='box'>
                  ...
                  गोत्र:
                   ...
                   <label style ={{ color:'yellow'}} htmlFor='fatherName'>{gotra}</label>
                </div> */}
                {/* <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor="nanlakksa">
                  कुलदैवत:
                  </label>
                   <label style ={{ color:'yellow'}} htmlFor="nanlakksa">{kuldevta}</label>
                </div>
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor='dob'>
                  देवक:
                  </label>
                   <label style ={{ color:'yellow'}} htmlFor='dob'>{dewak}</label>
                </div>
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor='email'>
                  नक्षत्र:
                  </label>
                   <label style ={{ color:'yellow'}} htmlFor='email'>{naksatra};</label>
                </div>
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor='name'>
                  राशी:
                  </label>
                   <label style ={{ color:'yellow'}} htmlFor='name'>{rashii}</label>
                </div> */}
                ...
                {/* <div className='box'>
                  ...
                  गण:
                   ...
                   <label style ={{ color:'yellow'}} htmlFor='age'>{gann}</label>
                </div>
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor='religion'>
                  नाडी:
                  </label>
                   <label style ={{ color:'yellow'}} htmlFor='religion'>{naadi}</label>
                </div> */}
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor='mob'>
                  ऊंची:
                  </label>
                   <label style ={{ color:'yellow'}} htmlFor='mob'>{height}</label>
                </div>
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor='dob'>
                  वर्ण:
                  </label>
                   <label style ={{ color:'yellow'}} htmlFor='dob'>{varn}</label>
                </div>
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor='jobTitle'>
                  रक्तगट:
                  </label>
                   <label style ={{ color:'yellow'}} htmlFor='jobTitle'>{bloodGroupInput}</label>
                </div>
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor='age'>
                  जन्मतारीख:
                  </label>
                   <label style ={{ color:'yellow'}} htmlFor='age'>{selectedDate}/{selectedMonth}/{selectedYear}</label>
                </div>
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor='religion'>
                  जन्म वेळ:
                  </label>
                   <label style ={{ color:'yellow'}} htmlFor='religion'>{dobDayName}</label>
                </div>
                ...
                <div className='box'>
                  ...
                  जन्म स्थळ:
                   ...
                   <label style ={{ color:'yellow'}} htmlFor='jobTitle'>{birthPlace}</label>
                </div>
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor='address'>
                  शिक्षण:
                ...
                <div className='box'>
                  ...
                  नोकरी/व्यवसाय:
                   ...
                   <label style ={{ color:'yellow'}} htmlFor='fatherName'>{job}</label>
                </div>
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor="nanlakksa">
                  वेतन/उत्पन्न:
                  </label>
                   <label style ={{ color:'yellow'}} htmlFor="nanlakksa">{salary}</label>
                </div>
                ...
                <div className='box'>
                  ...
                  {yateAathiraktaSirsakTitle}
                   ...
                   <label style ={{ color:'yellow'}} htmlFor="nanlakksa">{yateAathiraktaSirsak}</label>
                </div>
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor="nanlakksa">
                  {yateAathiraktaSirsakTitle2}
                  </label>
                   <label style ={{ color:'yellow'}} htmlFor="nanlakksa">{yateAathirakta2}</label>
                </div>
   ...
   <label className='boxs'  style={boxStyles}>कौटुंबिक माहिती</label>
                ...
                <div className='box'>
                  ...
                  वडिलांचे नाव:
                   ...
                   <label style ={{ color:'yellow'}} htmlFor='email'>{vadilchaleNav}</label>
                </div>
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor="nanlakksa">
                  वडिलांचा व्यवसाय:
                  </label>
                   <label style ={{ color:'yellow'}} htmlFor="nanlakksa">{vadilachanWayasha}</label>
                </div>
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor="nanlakksa">
                  आईचे नाव:
                  </label>
                   <label style ={{ color:'yellow'}} htmlFor="nanlakksa">{aayicheNav}</label>
                </div>
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor="nanlakksa">
                  बहीण:
                  </label>
                   <label style ={{ color:'yellow'}} htmlFor="nanlakksa">{bahin}</label>
                </div>
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor="nanlakksa">
                  भाऊ:
                  </label>
                   <label style ={{ color:'yellow'}} htmlFor="nanlakksa">{bhau}</label>
                </div>
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor="nanlakksa">
                  मामा:
                  </label>
                   <label style ={{ color:'yellow'}} htmlFor="nanlakksa">{mama}</label>
                </div>
                {karuSaktaTitle1 ? (
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor="nanlakksa">
                  {karuSaktaTitle1}:
                   ...
                   <label style ={{ color:'yellow'}} htmlFor="nanlakksa">{karuSakta1}</label>
                </div>
                ) : null}
                {karuSaktaTitle2 ? (
                <div className='box'>
                  ...
                  {karuSaktaTitle2}:
                   ...
                   <label style ={{ color:'yellow'}} htmlFor="nanlakksa">{karuSakta2}</label>
                </div>
                ) : null}
                {karuSaktaTitle3 ? (
                <div className='box'>
                  ...
                  {`${karuSaktaTitle3}:`}
                   ...
                   <label style ={{ color:'yellow'}} htmlFor="nanlakksa">{karuSakta3}</label>
                </div>
                ) : null}
                {karuSaktaTitle4 ? (
  <div className="box">
     ...
     <label style ={{ color:'yellow'}} htmlFor="nanlakksa">{karuSakta4}</label>
  </div>
) : null}
  ...
  >
    ...
    >
      || © वधु वर परिचय ||
                ...
                <div className='box'>
                   <label  style={{color:'yellow',position:'relative', left:55}} className='title' htmlFor="nanlakksa">
                  {name}
                  </label>
                  {/*  <label style ={{ color:'yellow'}} htmlFor="nanlakksa">aknna</label> */}
                </div>
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor="nanlakksa">
                  पत्ता:
                  </label>
                   <label  style={{color:'yellow',position:'relative', right:0}} htmlFor="nanlakksa">{addressLine1}</label>
                </div>
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor="nanlakksa">
                  {addressLineTitle2}
                  </label>
                   <label style ={{ color:'yellow'}} htmlFor="nanlakksa">{addressLine2}</label>
                </div>
                <div className='box'>
                   <label style ={{ color:'yellow'}} className='title' htmlFor="nanlakksa">
                  मो.नं.:
                  </label>
                   <label style={{color:'yellow',position:'relative', right:0}}  htmlFor="nanlakksa">{mob_no}</label>
                </div>
                </div>
              </div>
            </div>
