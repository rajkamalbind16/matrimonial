...
import img1 from '../../template1/mimg2.jfif';
    ...
    >
      || © वधु वर परिचय ||
                ...
                <div className='box'>
                  ...
                  <label  style={{position:'relative'}} htmlFor="nanlakksa">{addressLine1}</label>
                </div>
                <div className='box'>
                  <label className='title' htmlFor="nanlakksa">
                  {addressLineTitle2}
                ...
                <div className='box'>
                  ...
                  <label style={{position:'relative'}}  htmlFor="nanlakksa">{mob_no}</label>
                </div>
                </div>
              </div>
            </div>
