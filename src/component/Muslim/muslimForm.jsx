...
const handleSubmit = (event) => {
 ...
 if(temp == "MTemp1"){ console.log("true"), navigate(`/CreateMTemp1?${queryParams.toString()}`);}
 if(temp == "MTemp2"){ console.log("true"), navigate(`/CreateMTemp2?${queryParams.toString()}`);}
 if(temp == "MTemp3"){ console.log("true"), navigate(`/CreateMTemp3?${queryParams.toString()}`);}
 if(temp == "MTemp4"){ console.log("true"), navigate(`/CreateMTemp4?${queryParams.toString()}`);}
 if(temp == "MTemp5"){ console.log("true"), navigate(`/CreateMTemp5?${queryParams.toString()}`);}
