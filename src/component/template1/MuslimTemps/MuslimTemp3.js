...
{profilepic &&  <img
        ...
        {/* <div className='box'>
              ...
              <label className='bboxs' style={{position:'relative', color:'red',left:100}}  >||  नारा ए तकबीर  ||</label>
              </div> */}
             
              <div className='box'>
              
                <label className='bboxs' style={{position:'relative', color:'red',left:100}} >बायोडाटा</label>
                </div>
                <br/>
              <div className='box'>
                ...
                <div className='box'>
  <label className='bboxs' style={{position:'relative', color:'red',left:100}} >कौटुंबिक माहिती</label>
</div>
                ...
                <div className='box'>
                <label className='bboxs' style={{position:'relative', color:'red',left:100}}  >संपर्क</label>
                </div>
